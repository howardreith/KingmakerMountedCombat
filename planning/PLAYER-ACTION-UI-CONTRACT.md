...
NATIVE INTEGRATION: AP proved both actor bindings in the native character screen with unchanged resources/positions, but its wrong internal Hide call timed out. Candidate23 corrects only the fixture input path; actual native closure remains pending. No gameplay UI patch or human visual approval is inferred. The [Chunk4 report](../docs/CHUNK4-PLAYABILITY.md) tracks execution and restoration.
