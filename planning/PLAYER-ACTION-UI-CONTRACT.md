...
## Native character inspection close — Chunk4, 2026-09-13

ASSEMBLY CONTRACT: exact Kingmaker MVID07fa1e4d-8618-41b3-9b8d-faa17d3b26f7. ServiceWindowTabs.Hide0600477A is an internal finalizer and returns while IsShow=true. The ordinary FullScreenTabsWindow.OnButtonClose060046DD delegates to OnHotKeyEscPressed060046E0, then UIWindow.Show(false)060048A2 and native hide callbacks. No direct shown-state or game-mode assignment is needed. Five focused signature/delegation checks accompany the fixture's corrected lookup.

NATIVE INTEGRATION: AP proved both actor bindings in the native character screen with unchanged resources/positions, but its wrong internal Hide call timed out. Candidate23/AQ passed48/0, including both actor bindings and actual native close-button execution. No gameplay UI patch or human visual approval is inferred. The [Chunk4 report](../docs/CHUNK4-PLAYABILITY.md) tracks execution and restoration.

ASSEMBLY CONTRACT: native CameraRig.ScrollTo0600172E takes Vector3 and sets m_TargetPosition04001075; GetPosition0600173B reads that target. Candidate24 uses this existing A10 camera control after Horse fixture positioning. AR's actual camera images cropped the tested actors; corrected framing/recovery capture needs new native images. Camera target, renderer state and animation handles alone do not certify presentation.
