...
| Packaging/publication | Frozen Phase 1 diagnostic only | Phase 2A calibration identity `0.1.0-phase2a-dev.10`; exact Kingmaker AnimationModule allowlisted; guarded non-force branch publication; no release/main merge | Clean package allowlist, hashes/MVID, local/remote equality | IN PROGRESS |
