...
Focused preview.8: components354/0, source22/0, protocol53/0, structural lifecycle patch construction5/0, native movement signatures2/0. Detached checks do not qualify callbacks. Deployment harness244/0 after updating the exact schema expectation; old native and restoration assertions remain.
