...
|---|---|---|
| Whole loop, rider-first pre-pair initiative | IN PROGRESS | C completed one activation and renewed the next; FAIL on the curved movement measurement. Three complete activations still required. |
...
| External restoration | PASS | A/B/C independently match actual intake. Required again for every later transaction. |
