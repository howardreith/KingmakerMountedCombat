...
**IN PROGRESS - paused at the owner's request, 2026-09-14 01:18 UTC.** Published preview.32 has a new native/outer area-cleanup PASS (BG, 47/0). Farther slope candidates still failed before movement (BF, 20/1). The RT session fixture timed out before any encounter cycle (BH, 46/2); its cause remains unresolved. Slope, session cycles and exact-final regression remain open. All 60 temporary native transactions independently restored actual human preview.37 and protected data. No runtime session remains active.
