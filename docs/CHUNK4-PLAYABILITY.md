...
**IN PROGRESS - 2026-09-13 UTC.** Thirty-three new guarded transactions restored actual human preview.37 and data. AF/AG each passed47/0 native assertions for persistent rider death, unrelated turns, native encounter retirement and exact fixture restoration. Their outer failures exposed two validator assumptions: numeric error counters and native enemy automatic ending. Preview.20 corrects both and requires exact native ending callbacks. Fresh complete validation and remaining Chunk4 gates are pending; no scheduler defect is established.
...
| 20260913-chunk4-AG | preview.19 / dd3e91e | host47/0, child1/0, outer0/1 | Native persistent-death/cleanup PASS; outer FAIL incorrectly required player End for the native enemy |
...
AG also passed47/0 native assertions, in104.5469084 seconds. Its first unrelated actor was the disposable enemy: observed6358, native TurnController.End06000C46 callbacks462/463 at6436 changed Ending to Ended on the same turn119136000, then d79 prepared6484/observed6485. No player End was sent to a noncontrollable enemy. Preview.20 retains player input for eligible fixture actors and binds enemy automatic completion to its exact identity/control state. Every completed successor now requires one native ending callback pair with exact actor/turn/round/order/timing, before its next successor. The actual-shaped enemy fixture reproduced the prior failure;346/0 parser cases pass with20 new invalid-ending cases. Both immutable AF/AG children pass corrected validation, with original outer FAILs retained.
...
Earlier results and package checkpoints remain in [the journal](../MOUNTED-COMBAT-JOURNAL.md) and Git history. Evidence directories are outside Git/packages: runtime-evidence/20260908-chunk4-A..S, 20260909-chunk4-T..X, 20260912-chunk4-Y..AB and 20260913-chunk4-AC..AG. Original failed artifacts remain failures.

## Identities and evidence categories

Branch: codex/mounted-combat-phase3f-playable-core. AG source: dd3e91ec4ec00722c66de5a7da6f5be74970ca31, product0.1.0-chunk4-preview.19. AF source: 2bc7a2144d4dc91a54cf336e5595dd90286bf6f2. AE source: 5699d391ccaa7ae66005cf6a9f1c9a3ede956d93. AD source: 36256190ec1a49568451a63fccbcd123a4a901c6. AC source: 751efecc374e97961403f6053deeaf9808db82cd. Z/AA/AB source: f12e0433c51190960b77def625c7cd31b4c196ca.

| Item | Identity |
|---|---|
| Private package19 | KingmakerMountedCombat-0.1.0-chunk4-preview.19-native-life-counter-diagnostic.zip |
| ZIP / manifest SHA256 | dc7418e430165c7515710f0c5320c871bed4a17e55d285b5bf05d9165c62d27d / 706876a02553e0bb2e75f3c7760ac5ee34303fbfa462d77732e4418352dfdd75 |
| DLL SHA256 / MVID | 0e979eec09ad2d2cd58112dc6139f646436989bc1024ac7261d8e16530cd277b / c75f94ca-caaa-4f20-9f9e-442639dc8eac |
| Suite19 SHA256 | 3fe2a338c0b5e979cc232dd24f895b94ee5a32ed5fb0c47206069cfaa9b45141 |

COMPONENT: full preview.19 checks PASS exit0: real components376/0, metadata2/0, harness247/0, core325/0, play106/0, extended277/0, obstruction82/0, traversal74/0, outer45/0, Charge86/0; build/source22/0 and package11/0. Log tests19.txt SHA256f7278ed9c2a7399710b37a410573eba1596509405d0b4cd0b5075fcb1fcbc8db. Preview.20 builds; affected core346/0, obstruction82/0 and outer45/0 pass. Full preview.20 checks PASS exit0: components376/0, metadata2/0, harness247/0, core346/0, play106/0, extended277/0, obstruction82/0, traversal74/0, outer45/0, Charge86/0; Kingmaker546/0, read-only Wrath24/0, detached construction30/0 plus observers. Log tests20.txt SHA256a521588dc5a19fd7eb5b7807f23234c983d304c5cd05074aeb7febcb19d66ce1. Parser envelopes never certify gameplay; earlier checks remain in the journal/Git.
