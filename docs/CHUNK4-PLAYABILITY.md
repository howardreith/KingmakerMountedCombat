...
**IN PROGRESS - 2026-09-20 UTC.** BS37 completed native TB Charge but failed its claimed Pause window. BT38 then timed out awaiting global Pause, which native TB explicitly refuses. Candidate39 uses actual held Pause in RT and native planning/acting input in TB. Focused native proof and exact-final qualification remain required. All71 transactions restored actual human preview.37 and protected data.
...
Latest completed evidence by scope is below. It does not blanket-qualify candidate39. Exact original failures, hashes and chronology are retained in the [journal](../MOUNTED-COMBAT-JOURNAL.md), [resume record](../AUTONOMOUS-RESUME.md) and immutable runtime directories under `runtime-evidence/<run>`.
...
| `chunk4-charge-safety-tb`; BT | Source38,46/2 native/outer FAIL,0/1 child. First case times out waiting for global Pause; native DoStartMode06000CBF rejects Pause during TB. No native39 result yet. |
...
**COMPONENT:** Candidate39 Release/source22/0 and full checks exit0 PASS: components377/0,harness249/0,core375/0,play106/0,metadata2/0,extended367/0,obstruction106/0,traversal149/0,outer45/0,Charge460/0. Tests SHA`ae850e4b86a4435bc36063a3f78cfa69cf8a56583ac4e7d0761e24e1de397934`. DLL`a25618d8f07afb340c2aadbabf0fe4d9c513500d3311b53ff724dd4d3325ac26`/MVID`1712c0b8-daa1-4ffb-a712-ab3477f7b7b2`. Private39 source/package identities are recorded in ACTIVE-RUN and immutable manifest after commit; native results remain pending.
...
Published parent38 `dd8382bb8dc538d0f78109b06a6f075b99df82e0` / `0.1.0-chunk4-preview.38`: ZIP`e053d0378e11161573b663c551d7ff9b226a207dbf35b876d7a46e588ec2f996`, manifest`1aff7b2ea3a1918e2209ed56431942fcadc7e6293ba88992ecc6cccfb819f523`, suite`332db432f3e13a4bee01a25503f7faa087589d238781cec7357e294422bb11d9`; full build/tests/package passed, BT native qualification failed. Full earlier identities are in the journal/resume. Retained WhatIf30 PASS/no mutation covers unchanged transaction/admission/deployment only; Common39 adds post-run schema26 dispatch. Fresh package admission and live guards remain mandatory.

**NATIVE INTEGRATION:** First qualify39 Charge TB/RT, then exact-final sustained/interrupt/targeting/death/inspection/traversal/session cases, paired full-round orders, A05, accepted A10 and Horse/Mammoth regression. Prior passes retain their scope. **HUMAN PLAY:** pending. Two unsupported desktop-capture failures leave HUD/countdown and physical input unavailable; native scene images do not close those checks. No replacement automation.

## Restored state and targeted manual checks

All71 independent restoration audits PASS; latest BT at2026-09-20T01:00:04.5237512Z, log`9a9c0539cea0cb8ebab71f3d0dd9c5dd2574f2882fb6e890ba4df7d0529ffa14`. No game/lock at checkpoint. Saves`bc345a41d72f5c1538c9a5dcefc577202b0eb8279adbf1fa958cd63fb643519d`; fullMods`02aa64faba191ca51d80c2c35f521f2d6ef65c77911f86b3fb0e144a1d6c7878`; Params`dd22dc5aad012f0bca721de37d888a9163e9e759c44f7fa705e3355302be7e1e`. Human preview.37 DLL/cache`20080fdcf83c7628611c3f6354a3e47c3065e2b25998a9c01b39a69796ed57bb`, campaigns, immutable KMC_AUTOMATION_BASELINE and separatepreview.13 backup are preserved. No permanent deployment, foreign-mod edit, main merge or public release.
