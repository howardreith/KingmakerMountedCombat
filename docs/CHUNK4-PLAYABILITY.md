...
**IN PROGRESS - 2026-09-20 UTC.** Source41 passes obstruction CE. Charge RT CF rejects mounted Charge but fails its subsequent native ground-command completion assertion. Candidate42 adds the missing path/occupancy observations before deciding a repair; it keeps the failure assertion unchanged. All83 native transactions restored actual human preview.37 and protected data.
...
Latest completed evidence by scope is below. It does not blanket-qualify candidate42. Exact original failures, hashes and chronology are retained in the [journal](../MOUNTED-COMBAT-JOURNAL.md), [resume record](../AUTONOMOUS-RESUME.md) and immutable runtime directories under `runtime-evidence/<run>`.

| Stable scenarios / run suffixes | Result and scope |
|---|---|
| `chunk4-charge-safety-rt`; CF | Source41,46/2 native/outer FAIL. Mounted rider rejects safely with one warning and zero cost/motion, but legal ground recovery ends native Interrupt after2.429463m, rider Move0, .459m residual versus .3m arrival radius. Path endpoint/occupancy were missing; candidate42 records them without accepting Interrupt or changing gameplay. Later controls did not run. |
...
| `chunk4-obstruction-ranged-rt`; CE | Source41,47/0 native/outer PASS. Selected second eligible12m point;14/16m rings unexercised.167 blocked frames/6.522sec/60 samples/0 drops; native footprint .9 and current longbow range retained. Stop/clear recovery deliver three eligible bows and preserve fourth native melee tail/costs; targets released and combat exited. CD40 remains a fixture-selection FAIL. |
...
CF41 supplies a different failure: native movement interrupts the legal post-Charge order outside its arrival radius. Rider Move remains0, so the error message's tax alternative is not observed. Candidate42 only records native path endpoints/radii, view positions and nearby actor footprints before choosing a repair. Command Success, minimum travel and zero rider transport tax remain mandatory. The native interruption is retained as FAIL.

## Qualification and identities

**COMPONENT:** Candidate42 Release/source22/0 and full checks exit0 PASS: components377/0,harness249/0,core375/0,play106/0,metadata2/0,extended367/0,obstruction106/0,traversal149/0,outer45/0,Charge460/0. Tests SHA`ad8be9c7b71b6b262092cef1c97b600e7d6434e752fad5beff7c9eb7c0cd0389`. DLL`62c79aa72dbe76b7f8bb758496a4257b722dfd65f8f682a1be7574f97a2127a5`/MVID`a3e13712-9de8-47c7-932e-89b4723d5a7c`. Private42 source/package identities are recorded in ACTIVE-RUN and immutable manifest after commit; native results remain pending.
...
Published source41 `4115ec6ea8149e48b48952b21cca3f44df3a3257` / `0.1.0-chunk4-preview.41`: ZIP`07ce8d8500444d1263e784738bc68e84b00389f3584efdf67a1a28908cc69004`, manifest`ec50645bbf28cacda950dc0d88a3dc39baab30c08eb31aec86cedb48bb30eefd`, suite`44b325ed5cfe81082c0cc4ba236c42eab8256ddac31de384e83037580aa8da31`. Build/tests/package/guarded publication passed. CE passes; CF fails as recorded above. Exact history remains in journal/resume. WhatIf30 PASS/no mutation covers unchanged transaction/admission/deployment;42 launcher/Common unchanged from41. Fresh package/suite admission and live guards remain mandatory.

**NATIVE INTEGRATION:** First resolve42 focused RT Charge recovery, then qualify TB Charge, obstruction and exact-final sustained/interrupt/targeting/death/inspection/traversal/session cases, paired full-round orders, A05, accepted A10 and Horse/Mammoth regression. Prior passes retain their scope. **HUMAN PLAY:** pending. Two unsupported desktop-capture failures leave HUD/countdown and physical input unavailable; native scene images do not close those checks. No replacement automation.

## Restored state and targeted manual checks

All83 independent restoration audits PASS; latest CF at2026-09-20T03:00:57.6636343Z, log`9d00c36e9e8c5d78a7eb9834f5ccb68c30995c4d97ba45a062cb9fde88cc30d3`. No game/lock at checkpoint. Saves`bc345a41d72f5c1538c9a5dcefc577202b0eb8279adbf1fa958cd63fb643519d`; fullMods`02aa64faba191ca51d80c2c35f521f2d6ef65c77911f86b3fb0e144a1d6c7878`; Params`dd22dc5aad012f0bca721de37d888a9163e9e759c44f7fa705e3355302be7e1e`. Human preview.37 DLL/cache`20080fdcf83c7628611c3f6354a3e47c3065e2b25998a9c01b39a69796ed57bb`, campaigns, immutable KMC_AUTOMATION_BASELINE and separatepreview.13 backup are preserved. No permanent deployment, foreign-mod edit, main merge or public release.
