...
**IN PROGRESS - 2026-09-19 UTC.** Candidate33 fixes BH's diagnostic RT wait for TB-only bookkeeping. Its attempted run BI stopped before deployment because Steam was not running; no native result or new transaction is claimed. Candidate34 also prepares one exact native hub location for the slope fixture. Initial Working verification, actor identities, loading, collision, costs and all movement thresholds remain guarded. Slope, RT/TB sessions and exact-final regression remain open. All60 completed native transactions restored actual preview.37/data; fresh intake and the separate aborted-preflight audit match those bytes.
...
| `chunk4-session-rt`; BH | Preview.32, 46/2 native and outer FAIL. The Horse leaf exceeded its unchanged 30-second deadline at Phase3gControls, progress 2 / cycle 0 / zero ordinary events. Candidate33 repairs the fixture's wait for TB-only terminal fields in RT. BI never deployed because Steam was absent. No new session cycle or final subscription/record bounds are qualified. |
...
Candidate34 addresses the repeated physically level Dwarf_1 fixture failures by loading the exact native DungeonStartHub entry with AutoSaveMode.None before resolving/snapshotting/mounting the measured pair. It preserves the initial Working-save verification, checks unchanged campaign/main/rider/mount IDs, observes loading and ten stable world frames, and drains failed loading before cleanup. It never assigns coordinates or changes navmesh/footprint. The existing row/suite clocks are not restarted; actual half-metre elevation, .10 synchronization, path/movement/sample/cost assertions remain. The new location's suitability is unproved until a guarded native run. Focused traversal envelopes149/0 and Release build pass; full34 checks also pass (exit0).

## Qualification and identities

**COMPONENT:** Full 34 PASS (exit 0): components 377/0, harness 249/0, core 375/0, play 106/0, metadata 2/0, extended 319/0, obstruction 106/0, traversal 149/0, outer 45/0, Charge 86/0. Build/source 22/0 PASS. Tests SHA256 `5eb7e5d08cb0744d47db226c9eb9412c5b070a30797359ca7be8e36462d72265`. Parser envelopes do not certify gameplay.
...
BI (`20260919-chunk4-BI`) aborted at the existing Steam admission guard before lock/deployment/game launch. Its independent no-change audit passed at `2026-09-19T21:58:34.2074850Z`; preflight log SHA256 `a5fef7d989a267d2517cceeed71271c0dcba6bbab1ef49fbe0e9982bd4db7f66`. This does not increment the 60 native transactions. Native testing needs one already-running Steam client in the established offline state; the owner has been asked to open it and leave Kingmaker closed. No Steam account settings, credentials or guard were changed.
