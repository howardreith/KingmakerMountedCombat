...
| P06 | Preview49 future: native33/0 preserves world/debt/controls across three refused load entries, then moves/attacks; outer FAIL retained for missing validator registration and attributed cache recovery | Fresh corrected outer pass; native legacy/malformed/invalid actor/profile/campaign/configuration and unsafe participation cases |
...
The latest owned P06 process exited normally. Its preexisting profile files were unchanged; four new Unity analytics files were quarantined through exact run/token/content/evidence pins. Guarded recovery completed **2026-09-21T09:38:56.5635215Z**, restoring actual saves/settings/caches/foreign Mods. Preview49 native33/0 is causal evidence; its original outer FAIL is retained. Actual human preview.54 DLL `2203a68ca13dfebd1fc52be7c15521f3c2503c98cd53a891dd210ba0611019e9` was verified afterward, with no game process. Separate preview.37 and preview.13 backups remain intact. Recheck actual intake before every transaction; historical snapshots are never restoration authority over newer data.
