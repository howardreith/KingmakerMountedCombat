...
Preview24/source4da5791 alternating source17/0 PASS wrote mounted A and voluntarily dismounted B. Cold14/1 FAIL after loading B: removed native facts still had stale AbilityData hotbar slots, and capture incorrectly recorded those inactive bindings. Preview25 captures only current-world, currently leased active owned facts with exact AbilityData/caster; it does not invent facts to satisfy obsolete slots. Source22/0, components422/0 PASS; unchanged harness257/0 and fixtures63/0 remain. Native A/B/A plus subsequent save is pending. Human preview54 restored02:25:30.7737439Z. The runner copies only two fixed same-campaign/distinct-hash archives and supplies no actor/action state.
