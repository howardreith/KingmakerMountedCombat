...
The exact native `CR1_HorseRiding` file identities have been reverified. Summoned-pony resolution, runtime blueprint contracts, KMC companion implementation, Ranger integration, unmounted qualification, mounted profile work, target-selected Mount, packaging, and runtime evidence remain in progress.
...
| Pony comparison | IN PROGRESS | bounded runtime audit not yet run |
