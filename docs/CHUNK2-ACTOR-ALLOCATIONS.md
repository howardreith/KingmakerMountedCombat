...
Preview8 (`83b8912`) exact native regression: BB proper RT9/0 (54/0 assertions), CC TB ordinary19/0 (64/0). DD has two passing unmounted attack rows and passing tranche cleanup, but parent cleanup does not finish: global300s timeout, game16/1, outer result FAIL. DD is not a qualified transaction. All19 completed transactions restored actual intake; DD audit2026-09-07T07:52:02.6287071Z. EE/FF were not run. Preview9 adds only parent cleanup observation (target/Horse/native mode/pause/master/state/party membership) to identify the false condition before choosing a repair; build/source22/0. A10 remains incomplete.
