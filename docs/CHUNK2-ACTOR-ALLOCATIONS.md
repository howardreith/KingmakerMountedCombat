...
Preview8 (`83b8912`) exact native regression: BB proper RT9/0 (54/0 assertions), CC TB ordinary19/0 (64/0). DD has two passing unmounted attack rows and passing tranche cleanup, but parent cleanup does not finish: global300s timeout, game16/1, outer result FAIL. DD is not a qualified transaction. All19 completed transactions restored actual intake; DD audit2026-09-07T07:52:02.6287071Z. EE/FF were not run. Diagnostic9 GG repeats16/1 and identifies mode=False while target/Horse cleanup=True, actualTB=True/expectedTB=False, paused=False, and no Horse state/party/master residue. Preview10 reuses exact idle-party capture and native encounter cleanup after measurement; it validates identity and all-idle restoration. This is fixture teardown and does not qualify A09. All20 actual intake audits PASS, latestGG08:12:42.2989149Z. A10 remains incomplete until the final candidate runs.
