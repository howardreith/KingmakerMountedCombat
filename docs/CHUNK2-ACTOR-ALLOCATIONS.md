...
2026-09-07T02:30:45.8240954Z — Initial snapshot WhatIf stopped before mutation because the historical starting-installation allowlist lacked preview.13. Added only the exact three independently verified preview.13 names/hashes; retained cloneability, extra-file, exact-byte and fresh-whole-tree snapshot guards. Focused current-installation tests reject altered Info/DLL/cache bytes and extra files, then revalidate live read-only intake (6 PASS/0 FAIL). No launch or restore occurred; package1 remains immutable. Next package binds the guarded intake registration while preserving the identical diagnostic DLL.

2026-09-07T02:55:05.3025090Z - Native run 20260907-chunk2-rider-trace-A, source 5fa84f0f41a7a0d5aad0ee5bf418cbf045e5ec02, preview.1 DLL ba590eecd3d185d78c85c68fe878ca26cde0ab53307ae55834d869b567d08cfb: FAIL before movement. A fixture navigation search requested 0.1m although the helper requires at least 0.25m. No allocation discrepancy is established. The native artifact retains 31 preparation/callback events with zero observation errors/drops. Outer fixture cleanup then exceeded the existing 300-second host limit, so neither the trace nor native gameplay qualified. Preview.2 reuses the already qualified 0.75m native endpoint, retains failed samples and adds AI-round/native-cost observations and cleanup progress diagnostics. This changes the next observation; no production accounting change or timeout relaxation.

Guard restoration and independent fresh-intake audit PASS: complete saves and Mods digests exactly equal intake; preview.13 DLL/cache restored; lock absent and no game process remains. Evidence: runtime-evidence/20260907-chunk2-rider-trace-A and analysis-cache/runtime-evidence/chunk2-20260906/20260907-chunk2-rider-trace-A-restoration.json. Focused preview.2 build22/0, COMPONENT345/0, ASSEMBLY CONTRACT448/0, protocol11/0. A01-A10 remain TODO.
