...
if($Target-eq'Kingmaker'){
    ...
    foreach($expected in @(
        ...
        @('Kingmaker.UnitLogic.Abilities.Components.AreaEffects.AbilityAreaEffectRunAction',0x06002CD0,'OnRound'),
        @('Kingmaker.UnitLogic.Abilities.Components.AreaEffects.AbilityAreaEffectRunAction',0x04001D53,'UnitEnter'),
        @('Kingmaker.UnitLogic.Abilities.Components.AreaEffects.AbilityAreaEffectRunAction',0x04001D54,'UnitExit'),
        @('Kingmaker.UnitLogic.Abilities.Components.AreaEffects.AbilityAreaEffectRunAction',0x04001D55,'UnitMove'),
        @('Kingmaker.UnitLogic.Abilities.Components.AreaEffects.AbilityAreaEffectRunAction',0x04001D56,'Round'),
        @('Kingmaker.UnitLogic.Abilities.Components.AreaEffects.AreaEffectContextData',0x04001D52,'Entity'),
        @('Kingmaker.EntitySystem.Entities.AreaEffectEntityData',0x060082B9,'Tick'),
        @('Kingmaker.EntitySystem.Entities.AreaEffectEntityData',0x060082BB,'CreateExecutionProcess'),
        @('Kingmaker.EntitySystem.Entities.AreaEffectEntityData',0x060082BC,'UpdateUnits'),
        @('Kingmaker.EntitySystem.Entities.AreaEffectEntityData',0x060082BD,'UpdateSingleUnit'),
        @('Kingmaker.EntitySystem.Entities.AreaEffectEntityData+<get_UnitsInside>d__23',0x0600C067,'MoveNext'),
        @('Kingmaker.EntitySystem.Entities.AreaEffectEntityData+<CreateExecutionProcess>d__43',0x0600C070,'MoveNext'),
        @('Kingmaker.UnitLogic.Abilities.Blueprints.BlueprintAbilityAreaEffect',0x06002D07,'HandleRound'),
        @('Kingmaker.UnitLogic.Abilities.Blueprints.BlueprintAbilityAreaEffect',0x06002D08,'HandleTick'),
        @('Kingmaker.UnitLogic.Abilities.Blueprints.BlueprintAbilityAreaEffect',0x06002D04,'HandleUnitEnter'),
        @('Kingmaker.RuleSystem.RulebookEvent',0x060070D9,'get_Reason'),
        @('Kingmaker.RuleSystem.RuleReason',0x060070F8,'get_Context'),
        @('Kingmaker.UnitLogic.Mechanics.MechanicsContext',0x060021B3,'get_MaybeCaster'),
        @('Kingmaker.UnitLogic.Mechanics.MechanicsContext',0x060021B6,'get_SourceAbility'),
        @('Kingmaker.UnitLogic.Mechanics.MechanicsContext',0x04001706,'AssociatedBlueprint'),
        @('Kingmaker.UnitLogic.Commands.UnitAttack',0x06002679,'Init'),
    ...
    $checks=@(
        ...
        @('Kingmaker.RuleSystem.Rules.RuleApplyBuff',0x06007119,'OnTrigger'),
        @('Kingmaker.UnitLogic.Mechanics.Components.AddFactContextActions',0x060021F5,'OnNewRound'),
        @('Kingmaker.UnitLogic.Mechanics.Actions.ContextActionHealTarget',0x06002361,'RunAction'),
        @('Kingmaker.Blueprints.FactCollection',0x06009694,'AddFact'),
        @('Kingmaker.Blueprints.FactCollection',0x06009699,'RemoveFact'),
        @('Kingmaker.View.UnitMovementAgent',0x04001191,'m_WarmupTime'),
        @('Kingmaker.View.UnitMovementAgent',0x040011AC,'m_SlowDownTime'),
        @('Kingmaker.View.UnitMovementAgent',0x040011AE,'m_IsInForceMode'),
        @('Kingmaker.View.UnitMovementAgent',0x040011B6,'m_SavedMinSpeed'),
        @('Kingmaker.View.UnitMovementAgent',0x040011CB,'m_MinSpeed'),
        ...
        @('Kingmaker.Game',0x06000CC9,'LoadArea'),@('Kingmaker.Game',0x06000CD5,'LoadArea'),
        @('Kingmaker.Blueprints.Area.BlueprintAreaEnterPoint',0x06009C5E,'get_Area'),
        @('Kingmaker.EntitySystem.Persistence.AutoSaveMode',0x04005417,'None'),
        ...
        @('Kingmaker.View.CameraRig',0x0600173D,'SetRotation'),
        ...
        @('TurnBased.Controllers.TurnController',0x06000C6E,'UpdateActionPredictions'),
        @('TurnBased.Controllers.TurnController',0x06000C75,'UpdatePredictionsOnCursorMoved'),
        @('TurnBased.Controllers.TurnController',0x06000C3F,'SetAttackMode'),
        @('Kingmaker.Controllers.Clicks.PointerController',0x060093C7,'SimulateClick'),
        @('Kingmaker.Controllers.Clicks.PointerController',0x060093B2,'set_PointerOn'),
        ...
        @('Kingmaker.EntitySystem.Stats.ModifiableValue',0x06007EEB,'set_BaseValue'),
        @('Kingmaker.UnitLogic.Buffs.BuffCollection',0x060029F4,'AddBuff'),
        @('Kingmaker.UnitLogic.Buffs.Buff',0x060029E9,'Remove'),
        @('Kingmaker.Designers.Mechanics.Buffs.BuffExtraAttack',0x040059DB,'Number'),
        @('Kingmaker.Designers.Mechanics.Buffs.BuffExtraAttack',0x040059DC,'Haste'),
        @('Kingmaker.Designers.Mechanics.Buffs.BuffExtraAttack',0x06008A47,'OnEventAboutToTrigger'),
        @('Kingmaker.UnitLogic.UnitState',0x06001FB7,'AddCondition'),
        @('Kingmaker.UnitLogic.UnitState',0x06001FB9,'RemoveCondition'),
        @('Kingmaker.RuleSystem.Rules.RuleAttackRoll',0x06007135,'get_AttackBonus'),
        @('Kingmaker.RuleSystem.Rules.RuleAttackRoll',0x0600711D,'get_AttackBonusPenalty'),
        @('Kingmaker.RuleSystem.Rules.RuleCalculateAttackBonus',0x060071DC,'get_BonusSources'),
        @('Kingmaker.RuleSystem.Rules.RuleCalculateAttackBonus',0x04004AC0,'m_InnerRule'),
        @('Kingmaker.RuleSystem.Rules.RuleCalculateAttackBonus',0x04004AC3,'ConcealmentBonus'),
        @('Kingmaker.RuleSystem.Rules.RuleCalculateAttackBonus',0x04004AC4,'FlankingBonus'),
        @('Kingmaker.RuleSystem.Rules.RuleCalculateAttackBonus',0x060071D5,'get_Result'),
        @('Kingmaker.RuleSystem.Rules.RuleCalculateAttackBonusWithoutTarget',0x060071CE,'get_Result'),
        ...
        # Chunk 6A mid-encounter adoption reads these roster observables only.
        @('TurnBased.Controllers.CombatController',0x06000BBB,'FindUnitInfo'),
        @('TurnBased.Controllers.CombatController',0x06000BD2,'ChooseNextUnit'),
        @('TurnBased.Controllers.CombatController',0x06000BD3,'StartRound'),
        @('TurnBased.Controllers.CombatController',0x06000BE2,'HandleCombatStart'),
        @('TurnBased.Controllers.CombatController+TBUnitInfo',0x04007069,'Surprised'),
        @('TurnBased.Controllers.CombatController+TBUnitInfo',0x0400706F,'ActingInSurpriseRound'),
        @('TurnBased.Controllers.CombatController+TBUnitInfo',0x04007067,'Unit'),
        # Chunk 6A cost-ownership contract: these are the exact commitment seams.
        ...
        @('Kingmaker.EntitySystem.Entities.UnitEntityData',0x0600838F,'UpdateCooldowns'),
        @('Kingmaker.EntitySystem.Entities.UnitEntityData',0x0600837F,'HasMoveAction'),
        @('Kingmaker.EntitySystem.Entities.UnitEntityData',0x06008382,'UsedOneMoveAction'),
        @('Kingmaker.EntitySystem.Entities.UnitEntityData',0x06008383,'UsedTwoMoveAction'),
        @('Kingmaker.Controllers.Combat.UnitCombatState+Cooldowns',0x0600C3BE,'Clear'),
