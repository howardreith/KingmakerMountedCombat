...
param(
    [ValidateSet(
        ...
        'mounted-pair-load-safety','mounted-pair-area-transition-safety','fixture-intake','persistence-isolation','persistence-p01-save','persistence-p01-load','persistence-p02-save','persistence-p02-load','persistence-p03-save','persistence-p03-load','persistence-p05-save','persistence-p05-load','lifecycle-suite','combat-lifecycle-suite',
...
try{
    ...
    if($Scenario -cin @('persistence-isolation','persistence-p01-save','persistence-p01-load','persistence-p02-save','persistence-p02-load','persistence-p03-save','persistence-p03-load','persistence-p05-save','persistence-p05-load')){
