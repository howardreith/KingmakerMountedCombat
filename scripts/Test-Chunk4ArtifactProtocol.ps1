...
. (Join-Path $PSScriptRoot 'Test-Chunk4GroundProtocol.ps1')
...
foreach($root in @('chunk4-rider-incapacitation-tb','chunk4-rider-death-tb','chunk4-mount-death-tb','chunk4-targeting-rider-rt',
    ...
    'chunk4-obstruction-ranged-rt','chunk4-ground-arrival-rt')){
    $outer=if($root -ceq 'chunk4-obstruction-ranged-rt'){New-ObstructionEnvelope $true}
