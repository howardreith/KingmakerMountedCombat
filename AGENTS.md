...
Chunk 4 native engineering gates now PASS on preview.54/source `429377d707a9976be65639e0c27954d8b4ff3717`: 31 new exact-candidate roots include Charge safety, sustained combat, incoming targeting, native rider death, traversal/session cleanup and final paired/A05/A10/Horse/Mammoth regression. Visual/physical-input and HUMAN PLAY checks remain TODO in the [single report](docs/CHUNK4-PLAYABILITY.md). Preserve required paired configuration and distinct native budgets. Human preview.37 and actual data were restored; no permanent candidate installation, main merge or release is authorized. Full mounted Charge remains missing for Chunk 6. Chunk 5 persistence is roadmap only, not implementation authorized by this mission. Historical evidence remains in the report and journal.
