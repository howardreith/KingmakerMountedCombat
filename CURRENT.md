...
A10 on8: BB RT9/0 and CC TB19/0; DD unmounted2/0 leaf rows and tranche cleanup pass, but parent cleanup times out (game16/1, outer FAIL). All19 completed transactions restored actual preview13/current human state. A10 is incomplete; EE/FF not run. Preview9 adds only the missing parent cleanup observation before any repair. Guarded publication remains TODO.
