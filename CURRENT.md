...
First gate PASS in both initiative arrangements on preview.9 (I/J, 96/0 assertions). Preview.13 source `73ac250c5a9612c6b66fe6b520d0bf5080f6bf81` also passes P01/A05/P02 in N (49/0): same-grant Delay, partial native Stop, mode-exit forfeiture and refresh after 9.6 native seconds, step restriction and dismount participation. All fourteen transactions restored actual preview.13/current external state. Preview.14 now integrates ordinary actor selection and native prediction/Single controls; native qualification is pending. Remaining A01-A09, final-path A05/A10 and guarded publication remain IN PROGRESS. This milestone is not complete.
