...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Branch `codex/mounted-combat-phase3f-playable-core`. Published25/source79b6d14a2b1ef5e21dce7932bc7e89afd30d5fa5 passed P05 alternating source17/0+cold45/0, including a new native post-load save. Frozen26/source65853096cd10ab9781394a995677ca2be4a62218 is preserved with no native run.

Preview27 retains the P04 RT spent-action control and fixes a demonstrated read-side effect before runtime: querying the public native projectile iterator during an existing iteration resets its updating flag. The new regression fails on26 and passes with read-only access to verified native active/pending collections. Source22/0, components423/0 and native assembly/storage63/0 pass; unchanged harness258/0, metadata44/0 and owned fixtures77/0 remain. DLL75f39b2d5bb79cfea88d9acd833c4ea45060ca5d47301476c1cd84ecce616986/MVID7daaf3c7-278d-4bf7-a2ef-b03356b1ea70.

Preview28/source c772f28 (preserved) P04-unmounted-save-B passed native auto-pause and two ordinary attacks, then failed before saving: native Stop cancels only unstarted orders (060000B9); enabled party AI reacquired attacks until the owned target died. No save or cold load. Human intake restored03:30:27.1982642Z, preview54 DLL verified. Preview29 changes only the idle fixture: native AI-off at source, exact backing-state cleanup, cold assertion of the saved switch without injection, and explicit observation. Production remains27. Source22/0 build passes; next freeze/package29/suite30 and unmounted-save/load-C before mounted and active boundaries.

P01/all five P02 causal cold boundaries and P03 step/conversion/round-effect/reaction pass; P05 Manual/Quick/Auto rotation/cold/rename/alternation/post-save pass causally across22–25. Remaining P03 conditions/split/suspension, P04 active boundaries, P05/P06/P07 failures/invalid/lifecycle/removal, P08 and consolidated exact-final P01–P08 remain mandatory. Paired=true; legacy authorities/overlay=false. Chunk4 engineering accepted; visual/HUD/physical-input/HUMAN PLAY TODO. No permanent installation/main merge/public release.
