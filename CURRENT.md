...
P01 causal cold slice, five P02 boundaries, P03 step/conversion and native round effects pass across frozen candidates. Latest20/f753b6e round-effect-save-C31/0 and fresh load-C24/0 both outer PASS. Archive1c86a3e7d2606a4155258722a318123a2fbf285905a038068bf10fa349c0f32b; both loaded native buffs retain round1/damage2, then tick exactly once on two later activations. Full human restore00:31:01.4105580Z; preview54 verified; no game/lock.

Preview21 adds an exact reaction checkpoint: native enemy movement provokes the mount's one reaction, save on that unrelated turn, cold retained count/target obligation, repeated stimulus denied, two later true refreshes. No cold condition application, spawn, state injection or Mount. Native UnitState condition data preserves the disposable target's maneuver immunity. Build/source22/0, components415/0, fixture37/0 PASS; exact native contracts36/0 unchanged. Next freeze p03-reaction/suite22, guarded reaction-save-A/cold. Receipt: analysis-cache/chunk5-persistence/ACTIVE.json.

P03 conditions/split/suspension, P04 RT/active commands, P05 all save types/rotation/copies, P06 invalid data, P07 failure/lifecycle/removal and P08 regressions remain mandatory, followed by P01–P08 on the exact final package. Reuse proven preflight purity with mandatory current-data/package/process/restoration checks. Paired=true; legacy authorities/overlay=false. Only DLL entry cap5 MiB is owner-approved. Human preview54 and separate37/13 backups preserved; no permanent installation/main merge/release.
