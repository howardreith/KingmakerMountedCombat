...
A10 on7: TB ordinary19/0; RT AA reaches seven passing cases then exhausts the diagnostic target's128 temporary HP before Horse attack completion. Preview8 makes only a bounded RT fixture durability repair; its package and final regressions remain IN PROGRESS. All16 completed transactions restored actual preview13/current human state. Guarded publication remains TODO.
