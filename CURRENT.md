...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Frozen preview.48/source 76c9a2eff727f37c36b304061d9c4393d39f60f5 on codex/mounted-combat-phase3f-playable-core. P05 three queued native manual writes/cold PASS34/0+20/0, both outer PASS; callbacks match snapshots1/2/3, all three archives committed, cold reads actual Manual302. Unauthorized/suppressed writes0. Previous46 suspended same-round Delay source/cold PASS82/0+66/0 remains causal evidence.

Exact ZIP/DLL/MVID and suite50 are in the report and lab analysis-cache/chunk5-persistence/ACTIVE.json. Source22/components434/contracts89/package11 PASS; unchanged47 fixture181/harness259 and profile13 apply. Last restoration08:49:05.9783873UTC, no game, human preview.54 DLL verified. Current saves/settings/caches/foreign Mods and separate37/13 backups preserved. This documentation checkpoint does not rebuild frozen48.

Next: P06 early invalid/future/config refusal and owned offline mutation fixtures, then P07 recovery/lifecycle/removal, P08 and one consolidated exact-final P01–P08 suite. Exact entry tokens and unresolved seams are in lab pending-seams.json/load-entry-member-inventory.txt. Native44 timeout/world-reset recovery remains mandatory. Paired=true; legacy authorities/overlay=false. Chunk4 engineering accepted; visual/HUD/physical-input/HUMAN PLAY TODO. No permanent installation/main merge/public release.
