...
Matched native traces C-F each cover three rounds/six moves in both initiative orders and unmounted controls, all 46/0 assertions. They confirm the preparation callback timing defect and a delegated movement pacing discrepancy; entitlement semantics remain open. Preview.5 retains early reconciliation/actor retirement and restores native pacing. G failed diagnostic fact setup before measurement; native validation remains IN PROGRESS. Actual preview.13/current saves/Mods restoration is independently PASS after all seven transactions. See the concise Chunk 2 report for causal findings and identities.
