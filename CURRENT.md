...
The causal P01 round trip passed: preview.6 P01-save-D wrote archive `84ffb91c85fe10b0ccacc92befe9a1e4fd2be88e639f197f79bf9bd678c83270`; fresh-process preview.7 P01-load-B passed20/0 native and outer validation. The same native actors, three facts/two slots, ordinary movement and rider attack survived a complete process exit. Full actual intake restoration completed2026-09-20T20:19:07.2823584Z. Qualified preview.7/source9da3e05 and immutable package identities are in the report. The approved DLL-only5 MiB cap passed harness253/0; other limits and guards remain unchanged.

Development preview.8 now wires schema2 primitive combat metadata, schema1 in-memory migration, early native actor debt/AI restoration, constructor-only roster/current/partner contexts, paired participation and movement commitments. Load housekeeping discards old references without End/forfeit; native preparation/admission stays blocked until semantic rebind. The narrow combat save predicate retains all other native save gates. Components412/0, data42/0, installed-assembly/storage contracts28/0 and source22/0 PASS. No preview.8 native run/package exists; this is implementation/component evidence only. DLL `7ca90b3355deb500d6574f5e66e4dfbec1d00309fd87397095c3eb387bff6550`, MVID `745d9a95-1e1f-42be-935e-e938491483e3`.

Next: extend the existing owned P01 harness with stable P02 save/load IDs and a persistable native enemy fixture, then the smallest partial-movement real save/quit/cold load. The old diagnostic target uses an unregistered runtime faction and is unsuitable for a cold archive; use a validated native faction without changing shared blueprints. Cold setup may select TB configuration before loading, but may not inject gameplay state, reattach fixtures, spawn a companion or cast Mount. Then close P02-P08 and rerun P01 on the final candidate. Active exact source/publication receipt: `analysis-cache/chunk5-persistence/ACTIVE.json`.

Human preview.54/saves/settings/caches/foreign Mods remain restored; separate preview.37/preview.13 backups retained. No game/transaction remains. Paired=true; legacy authorities/overlay=false. No permanent installation/main merge/release.
