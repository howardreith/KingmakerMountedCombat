...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Frozen preview56/source 2ca053f60c5cf6837fb34fc75c4cb452bd61d95b passes both native damaged-combat cases, 49/0 each. Resolvable debt is retained, action admission stays blocked through a canceled queued load, a valid retry restores once, and two subsequent paired activations refresh normally. The original preview55 early-controller failure remains historical FAIL; preview56 waits for the complete native loading queue.

Human54/data/settings/caches/foreign Mods restored12:07:31.5495351UTC; no game/lock at checkpoint. Separate37/13 backups preserved. Exact package/DLL/suite/run identities: lab analysis-cache/chunk5-persistence/ACTIVE.json and p06-56-ledger.json (SHAf1a6a274f44e94be9a26a31264a0f2ad4d125ade8e997770c985cb869fabd711). Source22/components438/contracts107/package11 PASS; unchanged guard checks inherited from55. No permanent installation/main merge/public release.

Next candidate57 implements ordinary area suspension and native post-placement restoration before after-entry autosaves. First qualify a real area reload, post-transition save and cold load, then cross-area/automatic-save paths. Foreign native-header campaign, failed/canceled serialization/load, disable/removal, harmful lifecycle paths, P08 and one frozen exact-final P01–P08 suite remain mandatory. Paired=true; legacy authorities/overlay=false. Chunk4 engineering accepted; visual/HUD/physical-input/HUMAN PLAY pending. Full Charge remains Chunk6.
