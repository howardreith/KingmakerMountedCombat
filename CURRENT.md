...
Development43 corrects the condition fixture against installed native Tick06000C34/Prepare06000C3C: Preparing is the ready phase for a controllable actor until input/cost/lost-control. Native42 condition-save-B failed19/1 while waiting for Acting without input, after one genuine round-two mount preparation. The actual save, retained harm/forfeit, rider attack and normal restoration passed; no cold process ran. Human54 restored2026-09-21T07:12:37.8696547Z, exact DLL verified/no game. No persistence/gameplay behavior changes. Next build/tests/freeze43 and condition-save-C/cold-C.
