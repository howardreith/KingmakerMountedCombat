...
Partner-save-A on12 failed23/1 after writing: the mount stopped at its longer weapon reach, then the rider could not approach with exhausted mount movement. No failed archive was used for cold qualification. Full actual-intake restoration22:53:14.7110767Z; no game/lock. Preview.13 changes only this fixture's initial native movement to a walkable point within measured rider weapon reach, before mount expenditure. Build22/0 PASS; native13 pending. Preview13/sourceb8e5f31 passed partner-save-B34/0 and cold-load-B24/0, both outer PASS. Exhausted-save-A33/0 passed; cold-load-A native23/0 passed but outer FAIL because the five-row trace omitted a pre-input spent-work record. Human54 restored23:13:24.8852552Z. Preview14 adds that record and requires it without changing evidence bounds. Next freeze p02-spent-observation/suite15, exhausted cold-load-B from the passed source, then explicit-End save-A/cold. Preserve per-weapon reach and distinct budgets.
