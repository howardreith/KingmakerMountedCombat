...
Matched native C-F cover both orders and unmounted controls across three rounds, each46/0. H executes five rider-first rounds on preview5: T01/T02 coverage PASS, A05 fact observation FAIL (48/2 overall). It verifies early callback resource preservation and matched native movement pacing, while exposing stale Standard blocking later rider-first movement. Preview6 changes the diagnostic probe to Unit.Logic feature processing. Actual preview13/current saves/Mods restoration passed after all eight transactions. Actor-grant semantics and full A01-A10 closure remain open; see the concise report for the activation dependency and exact limits.