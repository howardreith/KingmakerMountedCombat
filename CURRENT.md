...
Preview15 waits for the next real unrelated turn before probing the ended pair. It also adds exact P03 step/conversion save/load fixtures: partial step remainder, Standard conversion, spent-work rejection and two true refreshes. No production persistence or gameplay cost/range change. Build22/0, components414/0, fixture31/0, harness255/0 PASS. Next commit/package p03-commitments, fresh suite16, End-save-B/cold, then P03 step-A and conversion-A save/cold; stop the batch on its first failure. Reuse prior purity proof; current-data, package, process and restoration checks remain mandatory.
