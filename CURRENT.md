...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Branch `codex/mounted-combat-phase3f-playable-core`. Frozen/published source64d524a9db786f99f5393b58b50d20dd79d16b44, preview23. This checkpoint is documentation only. Chunk 4 native engineering accepted; visual/HUD/physical-input and HUMAN PLAY remain TODO.

P01 and all five P02 causal cold boundaries pass; P03 step/conversion/round effects/reaction pass. P05 now has real Manual/Quick/Auto creation plus two overwrites/rotations each, same-session continuation, and actual cold loads. Manual source44/0+cold20/0 and Quick source44/0 were on22. Quick cold-A0/1 exposed the Manual-only diagnostic loader guard;23 fixes its exact declared type. Quick cold-B20/0 PID15776, Auto source44/0 PID12788+cold20/0 PID16984, and renamed Manual cold20/0 PID13012 all native/outer PASS on23. The renamed profile contains only Manual_811_KMC_RENAMED.zks, byte-identical to original archive709a859e35857a485ddebf7c42b9b998176f4551ba58eba74ce7ab57e7325c43; no original filename or external pair record.

Human preview54 fully restored01:51:40.3925922Z; exact installed DLL2203a68ca13dfebd1fc52be7c15521f3c2503c98cd53a891dd210ba0611019e9; no game/lock/session. Current saves/settings/foreign Mods and separate37/13 backups preserved. Package/source/suite/run identities: analysis-cache/chunk5-persistence/ACTIVE.json. Source22/0, components421/0, harness256/0, owned fixtures52/0, native assembly/storage55/0, package11/0 PASS.

Next implement P05 alternating A/B/A native loads in one process and a subsequent native save after cold restoration. Reuse two fixed owned archives (mounted A, legitimately unmounted B), exact hashed descriptor entries and existing root/campaign authority. No actor/state injection from runner logs. Native snapshot/worker ordering, failure cleanup and loading abandonment remain required; bounded simultaneous requests and fault testing may share this fixture. Preserve the frozen23 payload and source until a new candidate is frozen.

Remaining mandatory: P03 conditions/split/suspension; P04 RT/active commands/unmounted control; remaining P05/P06/P07 invalid/failure/lifecycle/removal; P08 regression; P01–P08 consolidated on one final package. No overall completion. Paired=true, legacy authorities/overlay=false; only DLL cap5 MiB owner-approved. Reuse proven preflight purity with mandatory fresh actual-data/package/process/restoration checks. No permanent installation/main merge/release.
