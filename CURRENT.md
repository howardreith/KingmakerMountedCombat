...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Integration branch `codex/mounted-combat-phase3f-playable-core`; last published5071d0a. Chunk4 native engineering accepted; visual/HUD/physical-input and HUMAN PLAY remain TODO.

P01 causal cold slice and all five P02 boundaries pass across earlier frozen candidates. P03 step passes16. Conversion save-B46/0 and fresh load-B29/0 both outer PASS on17/sourcea818992: native Move4.31344461/Standard0 preserved, only remaining movement usable, two later refreshes. Archive SHA256 df00ec68b707cfa0feebed542e6a814c4d651be191fb6fd07fce204538aa20d4. Full human restoration23:59:12.3529785Z, preview54 DLL verified; no game/lock. Separate37/13 backups retained.

Preview19 carries the native self-cast KameberryPieBuff round-effect checkpoint. No production change: verify no replay on cold materialization and exactly-once healing for both actors at two later activations. Build/source22/0, components414/0, owned fixture guards33/0 PASS. Round-effect-save-A on18 was rejected before launch by a missed exact-case validator; intake restored00:14:56.1193269Z. Preview19 adds that case and its harness test. Next freeze p03-round-effect-request/suite20, save-B/cold. Exact receipt: analysis-cache/chunk5-persistence/ACTIVE.json.

P03 reaction/condition/split, P04 RT/active commands, P05 all save types/rotation/copies, P06 invalid data, P07 failure/lifecycle/removal and P08 regressions remain mandatory, then consolidate P01–P08 on the exact final package. Reuse proven preflight purity with mandatory current-data/package/process/restoration checks. Paired=true; legacy authorities/overlay=false. Only DLL entry cap5 MiB is owner-approved. No permanent installation/main merge/release.
