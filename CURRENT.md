...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Frozen preview54/source b3696e181b451f4fbd1ff075bfd92395afd6dfbb passes actual locked-replacement failure/recovery59/0 plus fresh cold20/0. Native worker completion now governs save success; serializer tasks drain before failure cleanup. The old archive remains byte-identical and loadable; retry save, movement/attack and a fresh-process load succeed. Preview53 timeout/cancel and preview52 P06 remain causal evidence, not final-suite qualification.

Human54/data/settings/caches/foreign Mods restored11:30:10.6562168UTC; no game/lock. Separate37/13 backups preserved. Exact package/DLL/suite/run identities: lab analysis-cache/chunk5-persistence/ACTIVE.json and p07-54-ledger.json (SHA2a4d0ebe1a61a4aabb808194bf3f9d2b12c6423c7ffd15a3d57d844ce7d1d3aa). Source22/components437/contracts107/fixtures201/harness261/package11 PASS. No permanent installation/main merge/public release.

Next: close invalid/unfinished combat restoration admission and queued-load cancellation; qualify native foreign-header campaign, damaged combat participation and duplicate/failed-load paths. P07 native serialization cancellation, area/view/disable/removal; P08 and one frozen exact-final P01–P08 suite remain mandatory. Do not erase an unfinished restoration's combat fence when a queued load is canceled. Paired=true; legacy authorities/overlay=false. Chunk4 engineering accepted; visual/HUD/physical-input/HUMAN PLAY pending. Full Charge remains Chunk6.
