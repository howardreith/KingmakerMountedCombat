...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Integration branch `codex/mounted-combat-phase3f-playable-core`; published/frozen source1756a4b8c70fc3293d2d46271f7d8a2908929cbf, preview21. Chunk4 native engineering accepted; visual/HUD/physical-input and HUMAN PLAY remain TODO.

P01 causal cold slice, five P02 boundaries, P03 step/conversion/round effects/reaction pass across frozen candidates. Latest21 reaction-save-A45/0 PID7972 and fresh reaction-load-A31/0 PID12716 both outer PASS. Archive550c14c9eac7176e9dbfa3c301b5c1447832e0a09fdb24c3ecb21b9d3d9541fc retains mount reactions0/cooldown5.39999962/target obligation on the unrelated turn; repeated cold stimulus produces0 new reactions; next two preparations refresh. Full human restore00:41:49.2598005Z; preview54 verified; no game/lock.

Development22 adds the verified atomic ZIP replacement seam in native worker0600802A. It preserves original bytes, uses same-directory File.Replace after native commit, and rebinds ZipSaver path04005431. Original serialization/callback/failure/folder-save instructions remain intact. The isolated replacement lease admits only two completed writable same-slot native-type/name/area/hash entries. Components418/0, source22/0, native assembly/storage41/0 PASS, including real native ZIP success and locked-destination failure. This is offline evidence; no native22 package/run yet.

Next finish P05: retain isolated write ownership until native worker completion so failed staging cleanup is authorized; register exact manual/quick/auto final and temporary leaves, using native descriptors and bounded temporary slot settings. Add the stable P05 fixture, freeze22, prove actual manual overwrite first, then quick/auto rotation, repeated requests, copied/renamed cold inputs and alternating archives. Existing strict scenarios and protected input remain unchanged. No archive content rewrite after finalization. Local exact IL: analysis-cache/chunk5-persistence/save-commit-anchors.txt and zip-fields.txt. Receipt: analysis-cache/chunk5-persistence/ACTIVE.json.

Remaining mandatory: P03 conditions/split/suspension; P04 RT/active commands and unmounted control; P05 normal categories/rotation/copies/alternation; P06 invalid data; P07 interruptions/lifecycle/removal; P08 regressions; then P01–P08 on one exact final package. Reuse proven preflight purity plus current-data/package/process/restoration checks. Paired=true; legacy authorities/overlay=false. Only DLL entry cap5 MiB is owner-approved. Human preview54 and separate37/13 backups preserved; no permanent installation/main merge/release.
