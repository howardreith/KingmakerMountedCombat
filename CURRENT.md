...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Integration branch `codex/mounted-combat-phase3f-playable-core`; published source1756a4b8c70fc3293d2d46271f7d8a2908929cbf, frozen preview21. Chunk4 native engineering accepted; visual/HUD/physical-input and HUMAN PLAY remain TODO.

P01 causal cold slice, five P02 boundaries, P03 step/conversion/round effects/reaction now pass across frozen candidates. Latest21 reaction-save-A45/0 PID7972 and fresh reaction-load-A31/0 PID12716 both outer PASS. Actual archive550c14c9eac7176e9dbfa3c301b5c1447832e0a09fdb24c3ecb21b9d3d9541fc: mount reactions0/cooldown5.39999962 and disengagement target survive on the unrelated native turn; repeated movement gives zero new cold reactions; next two real paired preparations refresh normally. Full human restore00:41:49.2598005Z; preview54 DLL verified; no game/lock.

Next implement P05 normal manual/quick/auto overwrite and rotation through the existing isolated authority. Exact SaveManager.SerializeAndSaveThread0600802A commits/disposes the new archive, then deletes original before native ZipSaver.RenameFile0600806D. Extend that verified seam to atomic same-directory replacement, preserve last good on bounded failure, and keep test-root/type/campaign/hash/leaf guards. Local original IL/signatures: analysis-cache/chunk5-persistence/save-commit-anchors.txt; raw native source remains outsideGit. Do not rewrite finalized archive contents or relax old-scenario guards. Start with offline real-saver/authorization tests, then native writes and cold copies. Current receipt: analysis-cache/chunk5-persistence/ACTIVE.json.

Remaining mandatory: P03 conditions/split/suspension; P04 RT/active commands and unmounted control; P05 all normal categories/rotation/copies/alternation; P06 invalid data; P07 interruptions/lifecycle/removal; P08 regressions; then P01–P08 on one exact final package. Reuse proven preflight purity plus current-data/package/process/restoration checks. Paired=true; legacy authorities/overlay=false. Only DLL entry cap5 MiB is owner-approved. Human preview54 and separate37/13 backups preserved; no permanent installation/main merge/release.
