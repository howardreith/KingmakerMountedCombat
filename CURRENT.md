...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Frozen preview52/source0ff108e31ac39473a541886800b363e2365c1680 is published on the integration branch. Ten P06 native/outer runs pass335/0: legacy, schema1, missing rider/mount, mismatched profile, malformed data, unsupported profile, metadata campaign mismatch, policy mismatch and future schema. Accepted B/A loads release owned leases before native view disposal; rejected entries preserve the current world. Native foreign-header campaign and damaged combat-participation cases remain unqualified.

Human preview.54/data/settings/caches/foreign Mods restored10:30:46.1328279UTC; no game/lock. Separate37/13 backups are preserved. Lab analysis-cache/chunk5-persistence/ACTIVE.json contains exact package/source/DLL/suite/run identities; p06-52-ledger.json SHA985cbc936a0a679146f3d240d4eb13729625c9f9a0542fe1c6a606daf7cc593e binds all ten results. No permanent installation/main merge/public release.

Next: P07 pre-serialization timeout recovery and canceled queued-load semantics, with exact native queue/MoveNext/callback contracts. Prior44 timeout reset the world; do not relabel it. P06 remaining invalid participation/campaign cases, P07 storage failure/area/disable/removal, P08 and one frozen exact-final P01–P08 suite remain mandatory. Paired=true; legacy authorities/overlay=false. Chunk4 engineering accepted; visual/HUD/physical-input/HUMAN PLAY pending. Full Charge remains Chunk6.
