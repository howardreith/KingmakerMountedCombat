...
Preview7 matched native R/S/T/U each49/0 cover five rounds in both orders and corresponding unmounted controls. A05 has36 native preparation measurements with exact callback order, resources and effects. Early callback correction, native pacing and record retirement are implemented. Rider-first pre-Prepare entitlement remains unresolved: old Standard can deny movement before the Horse's next native grant. A01-A09 are not complete; the report states the remaining preparation/continuation dependency.

A10 on8: BB RT9/0 and CC TB19/0. DD and diagnostic9 GG pass two unmounted rows but fail parent cleanup; GG proves restored TB reactivates while the disposable party remains in combat, with target/Horse cleanup complete and game unpaused. Preview10 reuses exact idle-party fixture cleanup after measurement; final native regression is IN PROGRESS. All20 completed transactions restored actual preview13/current human state. This fixture repair does not qualify A09. Guarded publication remains TODO.
