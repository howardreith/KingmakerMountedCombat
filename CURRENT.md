...
First causal cold round trip PASS: P01-save-D on preview.6 wrote archive `84ffb91c85fe10b0ccacc92befe9a1e4fd2be88e639f197f79bf9bd678c83270` and passed23/0 native same-session checks. P01-load-B in fresh PID13092 on preview.7/source `9da3e0551c4c97f456690776a6465cf9983d4e6e` passed20/0 native and outer PASS: original actors, semantic restoration2/presentation1, three facts/two slots, no duplicates/Mount cast, ordinary movement and rider attack. Native ran20:18:02-20:18:54Z; normal exit and full actual intake restoration20:19:07.2823584Z. No game/lock remains. Earlier failures remain history.

Frozen preview.7 DLL `1d080296d571c52d1332cfa6b46abe77e7067986572f75feab5692243ecdbbb8`, MVID `76bd6522-303a-46a6-9dbf-bbfc93dc5a42`. Qualified `p01-load-world-cap5` ZIP `56561480e811540d7bd3301f64f7f2feef2d475623bc42e02011e089762a16fc`, manifest `d000ea32440a20ff2d7e83af6f9e0551533ab38ee58e36a7c1930252b3ce4391`; suite8 `b922c2c66c76b0982873bd52a345891201ef5bc2d945d8985aba5ea76bdc26b9`. Owner approved only DLL-entry5 MiB; other limits/guards unchanged. Harness253/0, source22/0, package11/0, components408/0, archive contracts23/0, prior data28/0. Original failed qualifier stays frozen/unqualified.
...
Next: P02 native combat/roster/current-turn state and movement commitment snapshots; dedicated early rebind without completed Prepare/End replay; then the smallest spent-action cold test. Preserve other native SaveAllowed gates when adding combat admission. P01 exact-final rerun and P02-P08 remain mandatory; combat persistence is not implemented yet. First resume command `git status --short`, then read `analysis-cache/chunk5-persistence/ACTIVE.json`.

Human preview.54/saves/settings/caches/foreign Mods restored; separate preview.37/preview.13 backups retained. Paired=true; legacy authorities/overlay=false. No permanent installation/main merge/release. Guarded publication currently6b92133; source9da3e05 is local.
