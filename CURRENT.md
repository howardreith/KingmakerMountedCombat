...
Preview18 adds the native self-cast KameberryPieBuff round-effect checkpoint. No production change: verify no replay on cold materialization and exactly-once healing for both actors at two later activations. Build/source22/0, components414/0, owned fixture guards33/0 PASS. Next freeze package p03-round-effect, fresh suite19, guarded round-effect-save-A/cold. Exact receipt: analysis-cache/chunk5-persistence/ACTIVE.json.
