...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Branch `codex/mounted-combat-phase3f-playable-core`; frozen preview.38/source `eb3cbe9bdcc17ea4e4ae4400c1e8062d99236980`. Native casting save/cold comparison PASS: unmounted390/0+370/0 and mounted690/0+720/0, all outer PASS. Exactly one source healing effect and spent spell slot survive; cold processes replay neither the effect nor the cast. Current Standard debt remains, ordinary attacks and two later refreshes work.

Exact private ZIP `KingmakerMountedCombat-0.1.0-chunk5-preview.38-p04-touch-commitment-diagnostic.zip`: SHA2ac086bb5e0f67aacf0106a0893bebd8c872f9344e5c8e097c3899d7c81ef93a; DLLc907f7f375ce5353ecbc23639cdcedc4f5d3b3fa54202a1035e15217041651eb/MVID62075da7-5ee7-4498-aaff-0ae45233ca80. Suite39 and complete identities in analysis-cache/chunk5-persistence/ACTIVE.json. Source22/0, components430/0, native contracts89/0, package11/0; unchanged harness258/0/fixtures144/0 apply.
...
Development40 corrects the prelaunch39 PowerShell condition-comparison grouping and adds a full orchestrator parser regression. The39 WhatIf failed before any game/save operation. Native condition fixture behavior is unchanged: retain native self-harm/forfeit, remove only owned test stimuli, then cold-load and measure principal remainder plus two later independent preparations. Source22/0 and parser PASS; unchanged components430/0, fixtures157/0 and native contracts89/0 apply. Full harness40 is running; native launch waits for PASS. DLL8c61ff4fa74961c9cfec317f38f7edf45849a608e1d18ab0fce38c93b4617408/MVIDdea3f7ba-33fb-40f8-9fd4-be89db1ab782. Next package40/suite41, guarded WhatIf, condition-save-A/cold-A. Human54 remains restored.
