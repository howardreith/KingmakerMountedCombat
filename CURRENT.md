...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Branch `codex/mounted-combat-phase3f-playable-core`. Preview24 adds a bounded P05 alternating fixture: real mounted A and voluntarily dismounted B saves, cold A → B → A native loads, then a new native save and ordinary movement/attack. No gameplay state is injected by the runner. Source23 `64d524a9db786f99f5393b58b50d20dd79d16b44` and its qualified payload remain frozen; documentation intake `d6b3632349c9baa789168abd3feeb72a06b44be9` is preserved.

Preview24 offline checks PASS: source22/0, components422/0, harness257/0, owned fixtures63/0. DLL60cf51a9c94d142cbb7f4417a1c43c0ae2d35e7945eaeaaa65606472e96b2937, MVID9e105f4b-a627-495f-9783-bc59f3ebcd2a. The second archive is accepted only for this exact case, same campaign, fixed leaf/name and distinct hash; strict single-save guards remain. Next freeze/package24, create a fresh qualification snapshot, run P05 alternating source and cold load through the guarded helper, and inspect actual evidence/restoration before further changes.

P01/all five P02 causal cold boundaries and P03 step/conversion/round-effect/reaction pass. P05 Manual/Quick/Auto actual creation, two overwrites/rotations each, cold loads and exact renamed copy pass causally on22/23. These are not final-candidate qualification. Native alternating24 is TODO.

Actual human preview54 restored01:51:40.3925922Z after the last23 run; DLL2203a68ca13dfebd1fc52be7c15521f3c2503c98cd53a891dd210ba0611019e9. No game/transaction was left; mandatory fresh intake/process/data checks precede each native run. Separate37/13 backups, human saves/settings and foreign Mods are preserved. Exact run/package pointers remain in analysis-cache/chunk5-persistence/ACTIVE.json.

Remaining: P03 conditions/split/suspension; P04 RT/active commands/unmounted control; remaining P05/P06/P07 invalid/failure/lifecycle/removal; P08 regression and consolidated P01–P08 on one final package. Paired=true, legacy authorities/overlay=false. Chunk4 engineering accepted; visual/HUD/physical-input and HUMAN PLAY TODO. No permanent installation, main merge or public release.
