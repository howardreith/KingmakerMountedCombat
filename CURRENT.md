# Chunk 5 owner-requested stopping point — 2026-09-21 UTC

IN PROGRESS; stopped at the owner's quota request. Do not start another implementation or native run until resumed. [Single report](docs/CHUNK5-PERSISTENCE.md). Frozen preview57/source 65395394494a7cb8c7519b925a932985e50fa1eb is guarded-published. Source22/components438/contracts110/owned-fixtures213/full-harness261/package11 PASS. The final documentation commit does not rebuild the payload.

Latest native root20260921-chunk5-P07-area-reload-save-A, PID14504: FAIL9/1 at the assertion requiring both party views to be replaced. Real unload/suspension and mounted restoration occurred; pair IDs, three facts/two slots and zero Mount casts were observed afterward. The post-area save, ordinary continuation and cold process were not reached. Read-only installed inspection shows cross-scene-root destruction is conditional on unloadCrossScene; measure the missing post-reload view IDs and verify the native call-site Boolean before changing this assertion. No gameplay defect is established by this failed view-replacement assumption. Original evidence remains FAIL.

Human chunk4-preview54 DLL2203a68ca13dfebd1fc52be7c15521f3c2503c98cd53a891dd210ba0611019e9 and actual data/settings/caches/foreign Mods restored12:33:37.2983296UTC; no game/active transaction. Separate37/13 backups preserved. Exact frozen package/DLL/suite/restoration/publication receipts: lab analysis-cache/chunk5-persistence/ACTIVE.json and p07-57-stop.json. No permanent installation/main merge/public release.

On resume: first run git status --short and read ACTIVE.json plus the last failed root's persistence-observations.jsonl. Add the missing native view observation and confirm LoadArea06000CD5's UnloadEntitiesCoroutine06008096 argument; qualify actual retained/replaced-view semantics, then complete area source/cold and cross-area/autosaves. Native foreign-header campaign, serialization/load failure/cancellation, disable/removal, harmful lifecycle paths, P08 and one frozen exact-final P01–P08 suite remain mandatory. Preview56 damaged-combat cases PASS49/0 each remain causal evidence. Required paired=true; legacy authorities/overlay=false. Chunk4 engineering accepted; visual/HUD/physical-input/HUMAN PLAY pending. Full Charge remains Chunk6.
