...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Integration branch `codex/mounted-combat-phase3f-playable-core`. Chunk 4 native engineering accepted; visual/HUD/physical-input and HUMAN PLAY remain TODO. P01, five P02 boundaries, P03 step/conversion/round effects/reaction have causal cold PASS, not exact-final acceptance.

Native preview22/source485715e65a21b3eafb1abcc6cb3360a025bb8e68: P05 manual-save-A44/0 PID16432 and manual-load-A20/0 PID6756 both outer PASS. Three distinct Manual archives at the same slot, live controls/debt and ordinary movement/attack retained; cold final archive709a859e35857a485ddebf7c42b9b998176f4551ba58eba74ce7ab57e7325c43. Quick-save-A44/0 PID1628 also outer PASS (three writes/two native rotations, archive45b06fcd2867f017c23d7322c17af21f53c58d46398fd3e6225c74fa4c2d0139). Quick-load-A0/1 PID13608 rejected before gameplay because WorkingFixtureLoader still required Manual. All restored; Auto did not start.

Candidate23 corrects only that diagnostic type guard from the exact validated P05 request, preserving every native path/name/campaign check. Adds one exact manual-renamed cold case: verified source bytes copied as Manual_811_KMC_RENAMED.zks, original filename absent, no archive/header rewrite. Components421/0, source22/0, harness256/0, owned fixtures52/0 and real native assembly/storage55/0 PASS. Next freeze/private package23/fresh suite, retry the preserved Quick archive as quick-load-B, Auto source/cold, then renamed Manual cold. Keep repo/bin frozen during native runs. Receipt: analysis-cache/chunk5-persistence/ACTIVE.json.

Human preview54 fully restored after failed cold Quick01:33:06.5435069Z; no game/lock. Exact human DLL2203a68ca13dfebd1fc52be7c15521f3c2503c98cd53a891dd210ba0611019e9. Current saves/settings/foreign Mods and separate37/13 backups preserved. Only DLL cap5 MiB is owner-approved.

Remaining mandatory: P03 conditions/split/suspension; P04 RT/active commands and unmounted control; P05 simultaneous/repeated requests and alternating archives; P06 invalid data; P07 failures/lifecycle/removal; P08 regressions; then P01–P08 on one exact final package. Reuse proven preflight purity with fresh current-data/package/process/restoration checks. Paired=true; legacy authorities/overlay=false. No permanent installation/main merge/release.
