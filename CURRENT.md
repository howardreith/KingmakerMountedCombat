...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Branch `codex/mounted-combat-phase3f-playable-core`. Frozen/published preview29 source `645a7907a87ed9ba0c96ceae1beaa853d4ca4564` passes the P04 idle spent-action control in RT: unmounted source21/0+cold18/0, mounted source24/0+cold18/0. Actual writes retain current debt, cold rebind precedes preparation, and both continuations observe two ordinary attacks with exactly-once native refresh. The source fixture explicitly selects native AI-off; cold reads that switch without injection. No active-command/projectile save qualification is claimed.

Private ZIP `KingmakerMountedCombat-0.1.0-chunk5-preview.29-p04-idle-ai-state-diagnostic.zip`: SHA419453a9909c9847d755d91192338432d8556e92807e27616a12926dfa365666; DLLb83a756e0df2cc6c48832ffce24ec081b32b13fb59467d15995323ee99649f7f/MVID214c3af2-784f-4dbe-9ed2-6d81073806ae. Unmounted archive639f5124c345bdbb440ec54ad1db025049c92ac977b2979e61f5a248d4528d43; mounted3c6ef9a96469fd3a3323c00cf004eaceb7447be55392ab127c7a8786fe87120e. Suite30 and exact run details: analysis-cache/chunk5-persistence/ACTIVE.json.

All four processes exited/restored. Last human preview54 restoration03:45:19.3679256Z; installed DLL2203a68ca13dfebd1fc52be7c15521f3c2503c98cd53a891dd210ba0611019e9 verified/no game. Actual saves/settings/caches/foreign Mods and separate37/13 backups remain protected. The failed27/28 source controls and frozen26 package remain intact; their diagnostic corrections changed no production action/cancellation rule.

Next: implement and test a bounded active-save barrier using verified native LoadingProcess ordering before the game-clock pause. Native Game.Tick suspends time while IsLoadingInProcess; waiting inside an ordinary loading iterator would stall effects. Native StartLoadingProcessInternal/IsLoadingInProcess/StopAll and UnitActionController Start/Tick seams are inspected outside Git. No speculative hook or active-save relaxation has been applied yet.

P01/all five P02 causal cold boundaries, P03 step/conversion/round-effect/reaction, P04 idle RT and P05 native types/rotation/rename/alternation/post-save have causal passes across candidates. P03 conditions/split/suspension, P04 active boundaries, remaining P05/P06/P07 failure/invalid/lifecycle/removal, P08 and consolidated exact-final P01–P08 remain mandatory. Paired=true; legacy authorities/overlay=false. Chunk4 engineering accepted; visual/HUD/physical-input/HUMAN PLAY TODO. No permanent installation/main merge/public release.
