...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Branch `codex/mounted-combat-phase3f-playable-core`. Published/frozen25/source79b6d14a2b1ef5e21dce7932bc7e89afd30d5fa5 passed P05 alternating source17/0+cold45/0, including a new native post-load save. Documentation intake7d7b638 is preserved.

Preview26 implements the next P04 control: native RT actor debt/references with no TurnController creation; preparation/cooldown ticks wait for semantic rebind. A weak completion marker distinguishes projectile arrival from completed OnHit effects, including the native pending-projectile list. Full enumeration preserves the native iterator's updating flag. RT active-command requests still reject while unsettled; bounded defer remains to implement after this idle spent-action control.

Two fixed P04 cases (unmounted-spent/mounted-spent) use actual native ordinary attacks, real Manual writes, cold metadata, saved cooldown admission and two subsequent native refreshes. No forced hit, cold target provision, remount or runner state injection. Offline PASS: source22/0, components423/0, harness258/0, metadata44/0, native assembly/storage61/0, owned fixtures77/0. Final build DLLb2d853ab4783f8e69889d841b4d38b081cb66c2c16c32c005cb6e60d78697e04/MVIDad64dac1-f6e6-471b-a2ff-1d8d5db4140e. Next freeze/package26, fresh suite27, unmounted-spent source/cold first; then mounted equivalent if the control passes.

No native26 run yet. Last full human preview54 restoration02:34:01.6364364Z; installed DLL2203a68ca13dfebd1fc52be7c15521f3c2503c98cd53a891dd210ba0611019e9 verified/no game. Actual saves/settings/foreign Mods and separate37/13 backups preserved. Fresh intake/process/data/restoration checks remain mandatory. Exact package/run pointers: analysis-cache/chunk5-persistence/ACTIVE.json.
