...
Preview27/source d25214ba42f361bdb0564c66a98610bae331b729 P04-unmounted-save-A failed3/1 before writing: the diagnostic Default-mode gate preceded its auto-pause handler. Native state was Pause with combat and unspent initiative; no persistence boundary had run. Human intake restored03:25:17.1331823Z, preview54 hash verified/no game. Preview28 changes only this diagnostic ordering (permits native Pause to reach the existing unpause handler); production remains27. Next freeze/package28/suite29 and unmounted-save/load-B, then mounted control if it passes.
