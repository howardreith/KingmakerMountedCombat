...
Preview.10/sourceaeb8e27 rider-save-A failed24/1 after a real write and same-session mount movement: Mount Primary targeting rejected the fixture as not a valid living target. Source archive is retained, but no cold run is authorized from that failed scenario. Full human restoration22:29:41.9470629Z/no game/lock. Preview.11 adds only read-only native target life/health and delivered damage observations to distinguish target incapacitation from an action defect. Production save/restore and native inputs are unchanged. Next: build/freeze11, fresh suite12, and guarded rider-save-B. Components413/0, fixture25/0 and harness254/0 qualify the unchanged checkpoint guards; no new full historical purity rehash is needed. P03-P08 and a consolidated exact-final suite, including P01, remain mandatory. Earlier P01 causal save/load passed across previews6/7; this does not qualify the final candidate. Active exact receipts: `analysis-cache/chunk5-persistence/ACTIVE.json`.
