...
P01 causal cold slice, five P02 boundaries, P03 step and conversion pass across earlier frozen candidates. Preview19 round-effect-save-B FAIL135/1 before write: rider healed once; mount's active due native buff remained round0/damage3. Native BuffCollection.Tick recognized only the principal. Full human restore00:22:18.3959506Z; preview54 DLL verified; no game/lock. Earlier18 attempt stopped at request validation before launch.

Preview20 extends only the two native buff owner/caster equality comparisons to an exactly prepared current paired partner. Native timers/delivery/removal remain unchanged; ended actors retain due effects without action permission. Domain ownership restoration/forfeit test PASS; components415/0, assembly/storage36/0, build/source22/0. Unchanged harness19 PASS255/0. Next commit/freeze p03-native-buff-timers/suite21 and round-effect-save-C/cold. Exact receipts: analysis-cache/chunk5-persistence/ACTIVE.json.

P03 reaction/condition/split, P04 RT/active commands, P05 all save types/rotation/copies, P06 invalid data, P07 failure/lifecycle/removal and P08 regressions remain mandatory, then P01–P08 on the exact final package. Reuse proven preflight purity with mandatory current-data/package/process/restoration checks. Paired=true; legacy authorities/overlay=false. Only DLL entry cap5 MiB is owner-approved. Human preview54 and separate37/13 backups preserved; no permanent installation/main merge/release.
