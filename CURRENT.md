...
Next: parameterize the existing P02 fixture for rider-spent, exhausted, explicit End/pending participation and partner-order boundaries. Then P03-P08 and a consolidated exact-final suite, including P01, remain mandatory. Earlier P01 causal save/load passed across previews6/7; this does not qualify the final candidate. Active exact receipts: `analysis-cache/chunk5-persistence/ACTIVE.json`.
