...
IN PROGRESS. [Single report](docs/CHUNK5-PERSISTENCE.md). Branch `codex/mounted-combat-phase3f-playable-core`; frozen preview.43/source `9eae8f54d75c15e62f9f86dff533a6baadec8e45`. P03 condition/split manual-save and cold-load PASS25/0+17/0, both outer PASS. Actual native self-harm14 and mount forfeiture survive at the same saved grant; unused rider attack works and both actors prepare exactly once in each of the next two rounds. The diagnostic condition was removed before saving; this proves its retained costs, not active-condition persistence.

Private ZIP `KingmakerMountedCombat-0.1.0-chunk5-preview.43-p03-native-ready-turn-diagnostic.zip`: SHA e46895fed29e3aecb132430e83643801fe9d84dada2d6d8f13f40cc4149918e8; DLL8a7da1c9bb01672b208ecba348bce463915a7e011593f0fdd3e25d9894b76b37/MVID57ffacf2-ed2a-4345-aa58-6e30e63fcb13. Suite45; complete identities in analysis-cache/chunk5-persistence/ACTIVE.json. Source22/0, components430/0, package11/0; unchanged contracts89/0, fixtures157/0, harness259/0 plus parser/parameter checks apply.

Both owned processes exited normally and restored actual intake; last2026-09-21T07:27:22.3340802Z. Human preview.54 DLL verified; no game process. Saves/settings/caches/foreign Mods and separate37/13 backups preserved. This documentation checkpoint does not rebuild frozen43.
...
Development45 permits only the exact command registered by current native paired preparation to finish during a save wait. Frozen44 preparation-save-A failed8/1 before any write: unstarted native SelfHarm was held until the 30s wait threw LoadGameException and the world reset. This also exposed the mandatory P07 graceful-failure gap. Human DLL/Mods/saves restored; one-run pinned profile recovery PASS2026-09-21T07:46:38.6440166Z restored the observed EternalKingdom False-to-True reset plus native startup deltas and released the lock. Source22/components430/contracts89/fixtures164/profile13 PASS; unchanged full harness259 applies. Next freeze45/suite47, preparation-save-B/cold-B. No new voluntary Mount or ordinary-command bypass.
