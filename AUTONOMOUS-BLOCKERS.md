...
The accepted-review repair is guarded-published at `611ebbb7bccf4fd32b0a8a427c462cd08202275d`. Exact combat forensics and all three contract-first records are now populated; source passes `21/0` and exact assembly contracts pass `119/0` (`108/0` Kingmaker, `11/0` Wrath). Commit and guarded-publish this contract checkpoint, then implement deterministic pair-combat domain behavior and exact scoped integration before guarded RT/TB runtime qualification. No critical blocker is active. Do not launch Wrath, touch another project, create a public release, merge `main`, or implement any unauthorized feature.
