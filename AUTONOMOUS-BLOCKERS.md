# Chunk 5 P07 area family complete — 2026-09-23 UTC

IN PROGRESS; the P07 area family is now qualified source and cold and no blocker remains. Frozen source 76593c8db517f50628355238014b25c6431e917e / 0.1.0-chunk5-preview.64. Source22/components439/contracts110/data56/owned-fixtures255/validation-copies61/full-harness261/**profile28**/package11 PASS.
...
Profile identity now excludes the installed game's own achievement cache — direct children of the profile root with the achievements.dat prefix at the native size, dozens of which date from 2024 — while nothing may disappear and every other path stays exact. The owner's SkipIntro mod is deliberate and needed no change; Params.xml now carries its UMM registration and restoration preserves it.

Human chunk4-preview54 DLL2203a68ca13dfebd1fc52be7c15521f3c2503c98cd53a891dd210ba0611019e9 installed, seven mod directories intact, 275 saves, both automation fixtures byte-identical, BASELINE immutable, no game process or transaction lock. Receipts: lab analysis-cache/chunk5-persistence/ACTIVE.json, return-entry-research63.md, area-transition-contract58.md.
