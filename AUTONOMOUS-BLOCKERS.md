...
Commit and guarded-publish the accepted-review record plus narrow UI/teardown regressions. Then complete exact Kingmaker/Wrath combat forensics and update the three combat contracts before writing combat production code. Continue through core RT/TB qualification, bounded stretch disposition, final private-alpha packaging, documentation, and guarded branch publication. Do not launch Wrath, touch another project, create a public release, merge `main`, or implement any unauthorized feature.
