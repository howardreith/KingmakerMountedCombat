...
Stationary mounted rider melee in real time is qualified twice from exact clean package `af4855f93e31084b2406a2b9e527b5d8587c5a7b82a52d61bb3863d7af777459` at guarded-published `07d44eb89c6a533bc99e386bad6fd3dac4a9ac73`. No critical blocker is active. The distinct turn-based schema-v5/native-rider-turn row passes every offline gate and is ready for a clean commit, guarded publication, package validation, full-continuity WhatIf, and fresh live A/B with an independent restoration audit after each process. Do not infer TB credit before both passes, and do not infer miss, invalid-target, target-death, non-mounted, or Mammoth-attack qualification from the RT pair; do not weaken product/native gates, launch Wrath, touch another project, create a public release, or merge `main`.
