...
namespace KingmakerMountedCombat.Diagnostics
{
    ...
    internal sealed class PersistenceIsolationBootstrap
    {
        ...
        internal static bool Supports(string value) => value == Scenario || value == "persistence-p01-save" || value == "persistence-p01-load" ||
            value == "persistence-p02-save" || value == "persistence-p02-load";
        ...
        internal bool TryPrepare()
        {
            ...
            if (!redirected)
            {
                ...
                if (request.Scenario == "persistence-p01-save" || request.Scenario == "persistence-p02-save") entries.Add(new PersistenceSaveEntry
                {
