    ...
    public sealed class RuntimeRequest
    {
        ...
        private void ValidateSaveBackedRequest(List<string> errors)
        {
            ...
            if (p05 ? Array.IndexOf(Scenario == "persistence-p05-load" ?
                ...
                p04 ? Array.IndexOf(new[] { "unmounted-spent", "mounted-spent", "unmounted-attack", "mounted-attack" }, PersistenceCase) < 0 : p03 ? Array.IndexOf(new[] { "step", "conversion", "round-effect", "reaction" }, PersistenceCase) < 0 :
