...
namespace KingmakerMountedCombat.Domain
{
    ...
    internal static class HorseCompanionScenarioDeadlinePolicy
    {
        ...
        internal static double HostDeadlineSeconds(bool actorAllocation, double aggregateScenarioSeconds = 0.0) =>
            Math.Max(actorAllocation ? AllocationScenarioSeconds + 60.0 : 300.0,
                aggregateScenarioSeconds + 60.0);
